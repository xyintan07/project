...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= url ?>assets/images/pages/apotek.jpeg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?= url ?>assets/images/pages/apotek2.jpg" class="d-block w-100" alt="...">
        </div>
    </div>
</div>
...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-50">
            <img class="w-50" src="<?= url ?>assets/images/pages/more.jpg" alt="">
            <img class="w-50" src="<?= url ?>assets/images/pages/more1.jpg" alt="">
            <img class="w-50" src="<?= url ?>assets/images/pages/more2.jpg" alt="">
            <img class="w-50" src="<?= url ?>assets/images/pages/more3.jpg" alt="">
        </div>
    </div>
</div>
