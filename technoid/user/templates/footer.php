        ...
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=kapsul">Kapsul</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=tablet">Tablet</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=sirup">Sirup</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Halaman</h6>
